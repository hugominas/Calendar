...
import ClassesBlock from "./ClassesLineClass";
  ...
  render() {
    ...
    return (
      <div class="group section">
        <div class="col span_1_of_12 fadeInUp animated">
          <div class="timeSche section group">
            <div class={'img'+this.props.period}></div>
          </div>
        </div>
        <div class="col span_11_of_12 fadeInUp animated">
          {classComponents}
        </div>
      </div>
    );
